...
\citetrack{txa:qio,asg:thesis}, and more recently with Quipper
\citetrack{quipper-pldi,quipper-rc}, the authors have
...
\citetrack{asg:thesis}, Green shows that this issue can be addressed
by moving to a more expressive type system, i.e. the dependently typed
programming language Agda \citemain{agda}. 
...
computing\citemain{oneway}.  The formal verification of 
...
Coecke's and Selinger's graphical calculi \citemain{ac1,seldccc}. 
We envisage
...
in Quantum Computation} \citetrack{txa:qio}. Green also lectured third
...
language. He co-authored two papers on Quipper: \emph{Quipper: A
  Scalable Quantum Programming Language} \citetrack{quipper-pldi},
which appeared in the proceedings of PLDI 2013, and \emph{An
  Introduction to Quantum Programming in Quipper}
\citetrack{quipper-rc}, which appeared in the proceedings of
...
A number of quantum programming languages have been proposed,
  ...
  level. Recently, Quipper \citetrack{quipper-pldi,quipper-rc} has
  ...
  30 trillion gates. Quantum process calculi \citemain{upro} have been
  ...
  \citemain{RudigerSurvey,GaySurvey}.
\item
...
quantum systems \citemain{kgqm}. Extensions of this calculus have been
used to verify some basic quantum protocols \citemain{perdrix}. 
\end{itemize}
...
Quipper \citetrack{quipper-pldi,quipper-rc} is an embedded, scalable,
...
typed setting \citemain{alti:tfp08} and we are hopeful that it should
...
\citemain{cacm} --- thus proving the usefulness of our approach for
...
\citemain{gonthier:four-colour-paper}.
...
quantum computation \citemain{oneway,meascalc}, topological quantum
computation \citemain{topological}, or even adiabatic quantum
computation \citemain{adiabatic} which is used by D-Wave's
